$(document).ready(function(){
    ...
    var plasmid21 = new Plasmid(new Array("E","b","X","1","M","2","S","b","P"), new Array("1"), true);
    var plasmid22 = new Plasmid(new Array("E","b","X","3","S","b","P"), new Array("1"), true);
    var plasmid2g = new Plasmid(new Array("E","b","X","3","M","1","M","2","S","b","P"), new Array("1"), true);
