$(document).ready(function(){
    ...
    var plasmid03 = new Plasmid(new Array("X","3","S","b","P"), new Array("1"), false);
    var plasmid0g = new Plasmid(new Array("X","3","S","b","P"), new Array("1"), false);
    ...
    var plasmid1g = new Plasmid(new Array("E","b","X","1","M","2","b","P"), new Array("1"), true);
    ...
    $(canvas).mousedown(function(e){
        ...
        if(goalPlasmids[0].bioBrickParts.toString() == currentPlasmids[0].bioBrickParts.toString() && goalPlasmids[0].backBone == currentPlasmids[0].backBone && goalPlasmids[0].backBoneParts.toString() == currentPlasmids[0].backBoneParts.toString()){
            gameClearMode = true;
        }
